      ...
      <div className="flex items-center gap-2">
        ...
        <div className="relative">
          ...
          >
            ...
            {unreadCount > 0 && (
              <span className="absolute -right-0.5 -top-0.5 inline-flex h-5 w-5 items-center justify-center rounded-full bg-rose-500 text-[10px] font-bold text-white ring-2 ring-white dark:ring-slate-950">
